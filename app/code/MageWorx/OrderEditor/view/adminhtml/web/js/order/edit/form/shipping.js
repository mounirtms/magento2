...
define(
    [
        'jquery',
        "MageWorx_OrderEditor/js/order/edit/form/items/taxRateFactory",
    ...
    function ($, taxRateFactory) {
        ...
        $.widget('mage.mageworxOrderEditorShipping', $.mage.mageworxOrderEditorBase, {
            ...
            getConfirmUpdateData: function () {
                ...
                var pickupStoreCode = 'mageworx_pickup_location_id',
                    pickupStore = $(self.params.shippingMethodBlockId)
                        .find('select[name^="shipping_method[' + shippingMethod + '][' + pickupStoreCode + ']"]')
                        .val();

                if (pickupStore && pickupStore.length) {
                    params[pickupStoreCode] = pickupStore;
                }
