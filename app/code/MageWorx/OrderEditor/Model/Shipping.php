...
class Shipping extends AbstractModel
{
     ...
     * @return \MageWorx\OrderEditor\Model\Shipping
     */
    public function setPickUpStore(string $pickupStore)
    {
        return $this->setData('pickup_store', $pickupStore);
    }
     ...
     * @return string
     */
    public function getPickUpStore(): string
    {
        return $this->getData('pickup_store')??'';
    }
    ...
    public function initParams(array $params)
    {
        ...
        if (isset($params['mageworx_pickup_location_id'])) {
            $this->setPickUpStore((string)$params['mageworx_pickup_location_id']);
        }
    ...
    public function updateShippingMethod()
    {
        ...
        $this->_eventManager->dispatch(
            'mageworx_order_shipping_method_updated_before_save',
            [
                'order' => $order,
                'shipping_model' => $this,
