...
namespace Mustafa\YalidineDelivery\Model\Service;
 ...
 *
 * Class Notification
 * @package Mustafa\YalidineDelivery\Model\Service
 */
class Notification
{
    const COMPLEX_MESSAGE_CONFIGURATION = 'YalidineNotification';
