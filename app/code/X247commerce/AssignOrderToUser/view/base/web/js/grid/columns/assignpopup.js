define([
    ...
    'jquery',
    'mage/template',
    'text!X247commerce_AssignOrderToUser/templates/grid/cells/assign/assignpopup.html',
    ...
    return Column.extend({
        ...
        getAdminscount: function (row) {
            return  row[this.index + '_adminscount']
        },
        ...
        preview: function (row) {
            var modalHtml = mageTemplate(
                sendmailPreviewTemplate,
                {
                    ...
                    adminscount: this.getAdminscount(row), 
